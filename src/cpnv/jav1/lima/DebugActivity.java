...
public class DebugActivity extends Activity 
	...
	public void onClick(View btn) {
		...
		case R.id.action1: // 
			...
			// Check behavior
			if ((art01.getNumber() == 0) && (art01.getResponsible().equals("A dÈfinir")) && (art01.getSupplier().equals("A dÈfinir")) && (art01.getPrice() == 0.0) && (art01.getVat() == 0.0)) nbpts++;
			...
			if ((art03.getName().equals("A dÈfinir")) && (art03.getNumber() == 100) && (art03.getResponsible().equals("Bernard")) && (art03.getSupplier().equals("Office World")) && (art03.getPrice() == 16.0) && (art03.getVat() == 2.5)) nbpts++;
			...
			if ((art05.getName().equals("Classeur")) && (art05.getNumber() == 100) && (art05.getResponsible().equals("A dÈfinir")) && (art05.getSupplier().equals("Office World")) && (art05.getPrice() == 16.0) && (art05.getVat() == 2.5)) nbpts++;
			if ((art06.getName().equals("Classeur")) && (art06.getNumber() == 100) && (art06.getResponsible().equals("Bernard")) && (art06.getSupplier().equals("A dÈfinir")) && (art06.getPrice() == 16.0) && (art06.getVat() == 2.5)) nbpts++;
		...
		case R.id.action2: // 
			...
			if ((book01.getNumber() == 0) && (book01.getResponsible().equals("A dÈfinir")) && (book01.getSupplier().equals("A dÈfinir")) && (book01.getPrice() == 0.0) && (book01.getVat() == 0.0) && (book01.getIsbn() == "A dÈfinir")) nbpts++;
			...
			if ((book03.getName().equals("A dÈfinir")) && (book03.getNumber() == 3300) && (book03.getResponsible().equals("Bernard")) && (book03.getSupplier().equals("Payot")) && (book03.getPrice() == 33.30) && (book03.getVat() == 8.0) && (book03.getIsbn() == "987654321")) nbpts++;
			...
			if ((book05.getName().equals("XML For Dummies")) && (book05.getNumber() == 3300) && (book05.getResponsible().equals("A dÈfinir")) && (book05.getSupplier().equals("Payot")) && (book05.getPrice() == 33.30) && (book05.getVat() == 8.0) && (book05.getIsbn() == "987654321")) nbpts++;
			if ((book06.getName().equals("XML For Dummies")) && (book06.getNumber() == 3300) && (book06.getResponsible().equals("Bernard")) && (book06.getSupplier().equals("A dÈfinir")) && (book06.getPrice() == 33.30) && (book06.getVat() == 8.0) && (book06.getIsbn() == "987654321")) nbpts++;
			...
			if ((book09.getName().equals("XML For Dummies")) && (book09.getNumber() == 3300) && (book09.getResponsible().equals("Bernard")) && (book09.getSupplier().equals("Payot")) && (book09.getPrice() == 33.30) && (book09.getVat() == 8.0) && (book09.getIsbn() == "A dÈfinir")) nbpts++;
		...
		case R.id.action3: // 
			...
			if ((gear01.getNumber() == 0) && (gear01.getResponsible().equals("A dÈfinir")) && (gear01.getSupplier().equals("A dÈfinir")) && (gear01.getPrice() == 0.0) && (gear01.getVat() == 0.0) && (gear01.getSize().equals("U"))) nbpts++;
			if ((gear02.getName().equals("Blouse")) && (gear02.getNumber() == 5800) && (gear02.getResponsible().equals("Hervé")) && (gear02.getSupplier().equals("H&M")) && (gear02.getPrice() == 72.10) && (gear02.getVat() == 8.0) && (gear02.getSize() == "XXL")) nbpts++;
			if ((gear03.getName().equals("A dÈfinir")) && (gear03.getNumber() == 5800) && (gear03.getResponsible().equals("Hervé")) && (gear03.getSupplier().equals("H&M")) && (gear03.getPrice() == 72.10) && (gear03.getVat() == 8.0) && (gear03.getSize() == "XXL")) nbpts++;
			if ((gear04.getName().equals("Blouse")) && (gear04.getNumber() == 0) && (gear04.getResponsible().equals("Hervé")) && (gear04.getSupplier().equals("H&M")) && (gear04.getPrice() == 72.10) && (gear04.getVat() == 8.0) && (gear04.getSize() == "XXL")) nbpts++;
			if ((gear05.getName().equals("Blouse")) && (gear05.getNumber() == 5800) && (gear05.getResponsible().equals("A dÈfinir")) && (gear05.getSupplier().equals("H&M")) && (gear05.getPrice() == 72.10) && (gear05.getVat() == 8.0) && (gear05.getSize() == "XXL")) nbpts++;
			if ((gear06.getName().equals("Blouse")) && (gear06.getNumber() == 5800) && (gear06.getResponsible().equals("Hervé")) && (gear06.getSupplier().equals("A dÈfinir")) && (gear06.getPrice() == 72.10) && (gear06.getVat() == 8.0) && (gear06.getSize() == "XXL")) nbpts++;
			if ((gear07.getName().equals("Blouse")) && (gear07.getNumber() == 5800) && (gear07.getResponsible().equals("Hervé")) && (gear07.getSupplier().equals("H&M")) && (gear07.getPrice() == 0.0) && (gear07.getVat() == 8.0) && (gear07.getSize() == "XXL")) nbpts++;
			if ((gear08.getName().equals("Blouse")) && (gear08.getNumber() == 5800) && (gear08.getResponsible().equals("Hervé")) && (gear08.getSupplier().equals("H&M")) && (gear08.getPrice() == 72.10) && (gear08.getVat() == 0.0) && (gear08.getSize() == "XXL")) nbpts++;
			if ((gear09.getName().equals("Blouse")) && (gear09.getNumber() == 5800) && (gear09.getResponsible().equals("Hervé")) && (gear09.getSupplier().equals("H&M")) && (gear09.getPrice() == 72.10) && (gear09.getVat() == 8.0) && (gear09.getSize().equals("U"))) nbpts++;
			if ((gear10.getName().equals("Blouse")) && (gear10.getNumber() == 5801) && (gear10.getResponsible().equals("Hervé")) && (gear10.getSupplier().equals("H&M")) && (gear10.getPrice() == 72.10) && (gear10.getVat() == 8.0) && (gear10.getSize() == "XXL")) nbpts++;
			gear03.setName("Blouse");
			if ((gear03.getName().equals("Blouse")) && (gear03.getNumber() == 5800) && (gear03.getResponsible().equals("Hervé")) && (gear03.getSupplier().equals("H&M")) && (gear03.getPrice() == 72.10) && (gear03.getVat() == 8.0) && (gear03.getSize() == "XXL")) 
			{
				gear03.setName("XM");
				if ((gear03.getName().equals("A dÈfinir")) && (gear03.getNumber() == 5800) && (gear03.getResponsible().equals("Hervé")) && (gear03.getSupplier().equals("H&M")) && (gear03.getPrice() == 72.10) && (gear03.getVat() == 8.0) && (gear03.getSize() == "XXL")) nbpts++;
			}
			gear04.setNumber(5800);
			if ((gear04.getName().equals("Blouse")) && (gear04.getNumber() == 5800) && (gear04.getResponsible().equals("Hervé")) && (gear04.getSupplier().equals("H&M")) && (gear04.getPrice() == 72.10) && (gear04.getVat() == 8.0) && (gear04.getSize() == "XXL")) 
			{
				gear04.setNumber(-5800);
				if ((gear04.getName().equals("Blouse")) && (gear04.getNumber() == 0) && (gear04.getResponsible().equals("Hervé")) && (gear04.getSupplier().equals("H&M")) && (gear04.getPrice() == 72.10) && (gear04.getVat() == 8.0) && (gear04.getSize() == "XXL")) nbpts++;
			}
			gear05.setResponsible("Hervé");
			if ((gear05.getName().equals("Blouse")) && (gear05.getNumber() == 5800) && (gear05.getResponsible().equals("Hervé")) && (gear05.getSupplier().equals("H&M")) && (gear05.getPrice() == 72.10) && (gear05.getVat() == 8.0) && (gear05.getSize() == "XXL")) 
			{
				gear05.setResponsible("X");
				if ((gear05.getName().equals("Blouse")) && (gear05.getNumber() == 5800) && (gear05.getResponsible().equals("A dÈfinir")) && (gear05.getSupplier().equals("H&M")) && (gear05.getPrice() == 72.10) && (gear05.getVat() == 8.0) && (gear05.getSize() == "XXL")) nbpts++;
			}
			gear06.setSupplier("H&M");
			if ((gear06.getName().equals("Blouse")) && (gear06.getNumber() == 5800) && (gear06.getResponsible().equals("Hervé")) && (gear06.getSupplier().equals("H&M")) && (gear06.getPrice() == 72.10) && (gear06.getVat() == 8.0) && (gear06.getSize() == "XXL")) 
			{
				gear06.setSupplier("X");
				if ((gear06.getName().equals("Blouse")) && (gear06.getNumber() == 5800) && (gear06.getResponsible().equals("Hervé")) && (gear06.getSupplier().equals("A dÈfinir")) && (gear06.getPrice() == 72.10) && (gear06.getVat() == 8.0) && (gear06.getSize() == "XXL")) nbpts++;
			}
			gear07.setPrice(72.10);
			if ((gear07.getName().equals("Blouse")) && (gear07.getNumber() == 5800) && (gear07.getResponsible().equals("Hervé")) && (gear07.getSupplier().equals("H&M")) && (gear07.getPrice() == 72.10) && (gear07.getVat() == 8.0) && (gear07.getSize() == "XXL")) 
			{
				gear07.setPrice(-72.10);
				if ((gear07.getName().equals("Blouse")) && (gear07.getNumber() == 5800) && (gear07.getResponsible().equals("Hervé")) && (gear07.getSupplier().equals("H&M")) && (gear07.getPrice() == 0.0) && (gear07.getVat() == 8.0) && (gear07.getSize() == "XXL")) nbpts++;
			}
			gear08.setVat(8.0);
			if ((gear08.getName().equals("Blouse")) && (gear08.getNumber() == 5800) && (gear08.getResponsible().equals("Hervé")) && (gear08.getSupplier().equals("H&M")) && (gear08.getPrice() == 72.10) && (gear08.getVat() == 8.0) && (gear08.getSize() == "XXL")) 
			{
				gear08.setVat(-8.0);
				if ((gear08.getName().equals("Blouse")) && (gear08.getNumber() == 5800) && (gear08.getResponsible().equals("Hervé")) && (gear08.getSupplier().equals("H&M")) && (gear08.getPrice() == 72.10) && (gear08.getVat() == 0.0) && (gear08.getSize() == "XXL")) nbpts++;
			}
			gear09.setSize("XXL");
			if ((gear09.getName().equals("Blouse")) && (gear09.getNumber() == 5800) && (gear09.getResponsible().equals("Hervé")) && (gear09.getSupplier().equals("H&M")) && (gear09.getPrice() == 72.10) && (gear09.getVat() == 8.0) && (gear09.getSize() == "XXL")) 
			{
				gear09.setSize("XXXXXX");
				if ((gear09.getName().equals("Blouse")) && (gear09.getNumber() == 5800) && (gear09.getResponsible().equals("Hervé")) && (gear09.getSupplier().equals("H&M")) && (gear09.getPrice() == 72.10) && (gear09.getVat() == 8.0) && (gear09.getSize().equals("U"))) 
				{
					gear09.setSize("");
					if ((gear09.getName().equals("Blouse")) && (gear09.getNumber() == 5800) && (gear09.getResponsible().equals("Hervé")) && (gear09.getSupplier().equals("H&M")) && (gear09.getPrice() == 72.10) && (gear09.getVat() == 8.0) && (gear09.getSize().equals("U"))) nbpts++;
				}
